...
extern float matThickness;  // This makes the global variable visible to this file
...
class Position {
    ...
    private:
        ...
        bool clamp() {
            ...
            z = constrainValue(z, -matThickness, restHeight, validMotionZ);
            
            // Corrected logic: Only check X and Y to allow Z plunging
            if (validMotionX && validMotionY) return true;
